<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ViewUsers.aspx.cs" Inherits="DBProject.ViewUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 ...
 <asp:Label ID="Message" runat="server"></asp:Label>
    ...
    <p>
       <center>
   <asp:GridView ID="UsersGrid" runat="server"  cssClass="rnd1" Font-Bold="True" HorizontalAlign="Center"  
