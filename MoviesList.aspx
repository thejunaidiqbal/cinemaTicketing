<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MoviesList.aspx.cs" Inherits="DBProject.MoviesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:Label ID="Message" runat="server"></asp:Label>
        ...
        <br />
    <p>  <center>
   <asp:GridView ID="MoviesGrid" runat="server"  cssClass="rnd1" Font-Bold="True" HorizontalAlign="Center"  
