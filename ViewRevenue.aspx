<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ViewRevenue.aspx.cs" Inherits="DBProject.ViewRevenue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 ...
 <asp:Label ID="Message" runat="server"></asp:Label>
        ...
        <br />
   <p> <center>
   <asp:GridView ID="RevenueGrid" runat="server"  cssClass="rnd1" Font-Bold="True" HorizontalAlign="Center"  
