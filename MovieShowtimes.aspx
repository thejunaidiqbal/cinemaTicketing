<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MovieShowtimes.aspx.cs" Inherits="DBProject.MovieShowtimes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /> <br /> <h2>Show Times</h2>
    <br />
    
    <p> 
        Movie: &nbsp; <asp:DropDownList ID="DropDownList1" AutoPostBack="true"  CssClass="tb"  runat="server"   >
        </asp:DropDownList>
        <br />
        <br />
         <asp:Button ID="Button1" CssClass="buttonCSS" runat="server" Text="Find Shows" OnClick="FindShows" />
         <br />
        <br />
 <asp:Label ID="Message" runat="server"></asp:Label>
    ...
    <p>  <center>
   <asp:GridView ID="ShowsGrid" runat="server"  cssClass="rnd1" Font-Bold="True" HorizontalAlign="Center"  
