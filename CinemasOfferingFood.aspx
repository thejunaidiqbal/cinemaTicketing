<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CinemasOfferingFood.aspx.cs" Inherits="DBProject.CinemasOfferingFood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <br /><br />   <h2>Food Options</h2>
    <br />
    
    <p> 
        Cinemas: &nbsp; <asp:DropDownList ID="DropDownList1" AutoPostBack="true"  CssClass="tb"  runat="server" OnSelectedIndexChanged="ListItems"  >
        </asp:DropDownList>
        <br />
        <br />
