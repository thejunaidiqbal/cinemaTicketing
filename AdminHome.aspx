<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="DBProject.AdminHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  <link rel="stylesheet" href="MyCssFile.css" type="text/css" charset="utf-8" />
<%--    <link rel="stylesheet" href="MySlide.css" type="text/css" charset="utf-8" />--%>
   ...
   <br /><br /> <h2>home</h2>
    ...
    <br /><br /><br />
      ...
      <asp:Repeater runat="server" ID="rpt" OnItemCommand="Redirect">
             <ItemTemplate>
